...
it('provides each cons macro', function () {
    expect(Collection::hasMacro('eachCons'))->toBeTrue();
});
...
it('can chunk the collection into consecutive pairs of values by a given chunk size of two with preserving the original keys', function () {
    $collection = new Collection([1, 2, 3, 4, 5, 6, 7, 8]);
