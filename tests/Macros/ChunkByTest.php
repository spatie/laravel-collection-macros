...
it('provides chunk by macro')
    ->expect(fn () => Collection::hasMacro('chunkBy'))
    ->toBeTrue();
...
it('can check the collection with a given callback and preserve the original keys', function () {
    $collection = new Collection(['A', 'A', 'A', 'B', 'B', 'A', 'A', 'C', 'B', 'B', 'A']);
...
it('chunk the collection with given callback with associative keys and preserve the original keys', function () {
    $collection = new Collection(['a' => 'A', 'b' => 'A', 'c' => 'A', 'd' => 'B', 'e' => 'B', 'f' => 'A', 'g' => 'A', 'h' => 'C', 'i' => 'B', 'j' => 'B', 'k' => 'A']);
